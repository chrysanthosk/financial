...
@section('title', 'Edit Recurring Template')

@section('content')
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h1 class="h3 mb-0">Edit Recurring Template</h1>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('expenses.recurring.update', $template) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mb-3">
                        ...
                        <input type="text" name="payee_name" maxlength="120" class="form-control"
                               value="{{ old('payee_name', $template->payee_name) }}" required>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input type="number" name="amount" step="0.01" min="0" class="form-control"
                               value="{{ old('amount', (string)$template->amount) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="expense_category_id" class="form-control" required>
                            @foreach($categories as $c)
                                <option value="{{ $c->id }}"
                                    @selected((int)old('expense_category_id', $template->expense_category_id) === (int)$c->id)>{{ $c->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="payment_method_id" class="form-control" required>
                            @foreach($methods as $m)
                                <option value="{{ $m->id }}"
                                    @selected((int)old('payment_method_id', $template->payment_method_id) === (int)$m->id)>{{ $m->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input type="number" name="day_of_month" min="1" max="28" class="form-control"
                               value="{{ old('day_of_month', $template->day_of_month) }}" required>
                    ...
                    <div class="col-md-2 mb-3 d-flex align-items-end">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="auto_create" name="auto_create" value="1"
                                   @checked(old('auto_create', (bool)$template->auto_create))>
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                                   @checked(old('is_active', (bool)$template->is_active))>
